...
export const PatientRegisterScreen = ({navigation}: Props) => {
  ...
  const onRegister = () => {
    ...
    const nutriCodigoPattern = /^[0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$/;
        ...
        if (passwordPattern.test(password)) {
          if (sexPattern.test(sex)) {
            if (celPattern.test(phoneNumber)) {
              if (nutriCodigoPattern.test(nutriCodigoId)) {
                signUp({
                  name,
                  userType,
                  fathersLastName,
                ...
                Alert.alert('El nutriCodigo NO cumple con las caracteristicas.');
              }
            } else {
        ...
        <View style={loginStyles.formContainer}>
          ...
          <ScrollView style={registerStyles.formContainer}>
            ...
            <TextInput
              ...
              maxLength={36}
              selectionColor="grey"
              onChangeText={value => onChange(value, 'nutriCodigoId')}
              value={nutriCodigoId}
              onSubmitEditing={onRegister}
              autoCapitalize="none"
              autoCorrect={false}
