...
export const PatientNavigator = () => {
  return (
        ...
        screenOptions={{
          ...
          <Stack.Screen name="WaterRegister" component={WaterMainScreen} options={{title : 'Registro Agua'}}/>
          <Stack.Screen name="ExcerciseRegister" component={ExcerciseMainScreen} options={{title : 'Ejercicio'}} />
          <Stack.Screen name="PotencialUsuarioNavigator" component={PotencialUsuarioNavigator} options={{title : 'Potencial Usuario'}}/>
          <Stack.Screen name="SearchFoodNavigator" component={SearchFoodNavigator} options={{title : 'Recetas'}}/>
